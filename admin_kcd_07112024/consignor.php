...
<script type="text/javascript">
    ...
    function PrintParty(from) {
        var search_text = ""; var url = "";
        search_text = jQuery('input[name="search_text"]').val();
        url = "reports/rpt_consignor_list.php?search_text="+search_text+"&from="+from;
